...
\]
These computations specify the needed free-action hypothesis in the local
quotient construction \cite[Section~3.2, pp.~10--11]{Engel}.
...
\begin{proof}
The extension lattice in (5.4) is Engel's Lemma~7.5.  For the differential,
